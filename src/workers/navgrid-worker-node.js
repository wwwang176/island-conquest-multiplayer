/**
 * Node.js worker_threads version of navgrid-worker.js.
 * Same logic as the browser worker, but uses parentPort instead of self.
 */
...
parentPort.on('message', (data) => {
    ...
    // BFS: distance from nearest land cell for water blocking
